...
function [output,bin_limits,output_info,hrs_out,dys_out,val_out] = get_psd_medians_conv( data_dir, station, years, months, sort_by)
	...
	function [all_data,data_bins] = get_all_data(data_dir,station,years,months)
	...
	[all_data,data_bins] = get_all_data(data_dir,station,years,months);
